function [ConnectivityPre,ConnectivityPost,ConnectivityPre_Areas,ConnectivityPost_Areas,GlobalChConnPre,GlobalChConnPost] = get_Imgcoherence(EEG_PreStim,EEG_PostStim,channelsEEG)
...
for is = 1:nsub
    ...
    if ~isempty(currentConn)
        ...
        connSpectrum = currentConn.cohspctrm; % 3D matrix: Chan x Chan x Freq;
        ...
        Connectivity_Areas{is}.cohspctrm = finalAreasConnMatrix;
